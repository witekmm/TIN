...
MSG = Messages/
NET = $(NT)NetLibs.h
OBJS = main.o CLI.o ServerConnections.o NetworkPipe.o LogicPipe.o NetworkConnections.o MainConstants.o Network.o ServerOperations.o Message.pb.o
CC = g++
...
CLI.o: $(CT)CLI.h	$(CT)CLI.cpp $(NT)Network.h
	$(CC) -c $(CT)CLI.cpp
